...
import { addSmurfFail, addSmurfSuccess } from '../actions';

const AddForm = (props) => {
    const { error, addSmurfFail, addSmurfSuccess } = props;
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            addSmurfFail("Name, Position, and Nickname are required fields");
        } else {
            addSmurfSuccess({
                ...state,
                id: Date.now()
