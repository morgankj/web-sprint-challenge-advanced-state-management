...
- Context API is a way to connect data throughout a large application - it does not care about storage, or your state-saving system. You can create global variables that are easily accessible throughout an application, across numerous components and files.
